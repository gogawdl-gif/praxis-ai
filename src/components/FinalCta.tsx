        ...
        <Reveal>
          <div className="relative overflow-hidden rounded-3xl px-8 py-20 text-center">
            ...
            <h2 className="relative font-display text-3xl font-medium tracking-tight text-white md:text-4xl">
              Turn what your company knows into training.
            </h2>
            <p className="relative mx-auto mt-4 max-w-sm text-white/85">
              Start with one document, one recording, or one process. Learnik does the rest.
            </p>
            <a
              href="#"
            ...
            <p className="relative mt-4 text-xs text-white/70">7-day free trial · No credit card required</p>
          </div>
        </Reveal>
      </div>
    </section>
