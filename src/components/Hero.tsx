...
const TOPICS = [
  {
    label: 'Onboarding',
    course: 'Opening store procedure',
    line: 'First you disarm the alarm, then power on the registers…',
  },
  {
    label: 'Support',
    course: 'Handling a return',
    line: 'Check the order in the portal, then confirm the item is unused…',
  },
  {
    label: 'Compliance',
    course: 'Cash handling policy',
    line: 'Every drawer count needs two signatures before close…',
  },
  {
    label: 'Process updates',
    course: 'New POS workflow',
    line: 'Skip the old discount screen — it moved under Payments…',
  },
]
...
export function Hero() {
  ...
  return (
    <section id="top" className="relative overflow-hidden pt-36 pb-20 md:pt-44">
      <div className="pointer-events-none absolute inset-0 -z-10 wash-section" />
      <div className="blob -z-10 left-[-6rem] top-[6rem] size-[26rem] bg-primary/10" style={{ backgroundColor: 'rgba(61,75,245,0.10)' }} />
      <div className="blob -z-10 right-[-8rem] top-[2rem] size-[24rem] bg-mint/15" style={{ backgroundColor: 'rgba(53,208,176,0.16)' }} />
          ...
          <AnimatePresence mode="wait">
            ...
            >
              <div>
                ...
                <p className="mt-2 text-[15px] text-ink-soft" style={{ color: '#4b4b5c' }}>
                  “{topic.line}”
                </p>
