...
const SLIDES = [
  { title: 'Record your screen', body: 'Click record, walk through the workflow. Mobbilise watches every click.', Visual: ScreenRecordMockup },
  { title: 'Just talk', body: "No slides needed. Explain the process out loud, Mobbilise writes it down.", Visual: VoiceMockup },
  { title: 'Drag in what you have', body: 'Docs, decks, old training videos. Point Mobbilise at your existing library.', Visual: DropzoneMockup },
      ...
      <div className="mx-auto max-w-6xl px-6">
        <Reveal className="mx-auto max-w-xl text-center">
          ...
          <p className="mt-3 text-ink-soft" style={{ color: '#4b4b5c' }}>
            Pick whatever's fastest for you. Mobbilise turns any of it into the same finished course.
          </p>
        </Reveal>
      </div>
